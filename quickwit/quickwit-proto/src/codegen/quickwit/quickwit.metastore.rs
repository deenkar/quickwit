...
/// reconstructed if the metastore is lost. Footer offsets are intentionally
/// omitted: they are derived from the bundle footer when the split is imported.
...
pub struct SplitRecoveryMetadata {
    ...
    /// Direct ancestors replaced by this split. This is intentionally not the
    /// transitive closure: recovery can reconstruct the lineage DAG from all
    /// manifests present in object storage.
    #[prost(string, repeated, tag = "17")]
    pub parent_split_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    /// Fixed-width encoding is required because this message is part of the split body: changing
    /// placeholder offsets to their final values must not change the position of the footer.
    #[prost(fixed64, optional, tag = "18")]
    pub footer_start: ::core::option::Option<u64>,
    #[prost(fixed64, optional, tag = "19")]
    pub footer_end: ::core::option::Option<u64>,
}
#[derive(serde::Serialize, serde::Deserialize, utoipa::ToSchema)]
